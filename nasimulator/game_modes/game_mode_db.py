...
class GameModeDB:
    """The :class:`~yawning_titan.config.game_modes.GameModeDB` class extends
    ...
    def insert(
        ...
        """Insert a :class:`~yawning_titan.game_modes.game_mode.GameMode` into
        the DB as ``.json``.
    ...
    def all(self) -> List[GameMode]:
        """Get all :class:`~yawning_titan.game_modes.game_mode.GameMode` from
        the game mode DB.
    ...
    def search(self, query: YawningTitanQuery) -> List[GameMode]:
        """Searches the :class:`~yawning_titan.game_modes.game_mode.GameMode`
    ...
    def update(
        ...
        """Update a :class:`~yawning_titan.game_modes.game_mode.GameMode`. in
        the db.
    ...
    def upsert(
        ...
        """Upsert a :class:`~yawning_titan.game_modes.game_mode.GameMode`. in
        the db.
    ...
    def remove(self, game_mode: GameMode) -> Union[str, None]:
        """Remove a :class:`~yawning_titan.game_modes.game_mode.GameMode`. from
        the db.
    ...
    def remove_by_cond(self, cond: QueryInstance) -> List[str]:
        """Remove :class:`~yawning_titan.game_modes.game_mode.GameMode`. from
