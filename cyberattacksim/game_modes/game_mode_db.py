"""Provides an API for the ``game_mode.json`` TinyDB file, and a Schema class
that defines the game_mode DB fields."""
...
class GameModeSchema:
    ...
    NETWORK_NODES: Final[NetworkNodeCompatibilityQuery] = (
        ...
        ).game_rules.network_compatibility.node_count)
    """Mapped to :attr:`~cyberattacksim.game_modes.game_mode.GameMode.game_rules.network_compatibility.node_count`."""

    ENTRY_NODES: Final[EntryNodeCompatibilityQuery] = (
        EntryNodeCompatibilityQuery(
        ).game_rules.network_compatibility.entry_node_count)
    """Mapped to :attr:`~cyberattacksim.game_modes.game_mode.GameMode.game_rules.network_compatibility.entry_node_count``."""

    HIGH_VALUE_NODES: Final[HighValueNodeCompatibilityQuery] = (
        HighValueNodeCompatibilityQuery(
        ).game_rules.network_compatibility.high_value_node_count)
    """Mapped to :attr:`~cyberattacksim.game_modes.game_mode.GameMode.game_rules.network_compatibility.high_value_node_count`."""

    NETWORK_COMPATIBILITY: Final[NetworkCompatibilityQuery] = (
        NetworkCompatibilityQuery().game_rules.network_compatibility)
    """Mapped to :attr:`~cyberattacksim.game_modes.game_mode.GameMode.game_rules.network_compatibility`."""

    CONFIGURATION: Final[
        GameModeConfigurationSchema] = GameModeConfigurationSchema
    """Use this to access the full schema of the database structured in the same nested format as :class:~`cyberattacksim.game_modes.game_mode.GameMode`."""
...
class GameModeDB:
    ...
    def _doc_to_game_mode(cls, doc: Document):
        ...
        Converts a :class:`tinydb.table.Document` from the :class:`~cyberattacksim.config.game_modes.GameModeDB` to an instance
        of :class:~cyberattacksim.game_modes.game_mode.GameMode`.

        :param doc: A :class:`tinydb.table.Document`.
        :return: The doc as a :class:`~cyberattacksim.game_modes.game_mode.GameMode`.
        """
    ...
    def insert(
        ...
        :param game_mode: An instance of :class:`~cyberattacksim.game_modes.game_mode.GameMode`
            :class:`~cyberattacksim.db.doc_metadata.DocMetadata`.
            :class:`~cyberattacksim.db.doc_metadata.DocMetadata`.
            :class:`~cyberattacksim.db.doc_metadata.DocMetadata`.
    ...
    def all(self) -> List[GameMode]:
        """Get all :class:`~cyberattacksim.game_modes.game_mode.GameMode` from
        the game mode DB.
    ...
    def get(self, uuid: str) -> Union[GameMode, None]:
        ...
        :return: The game_mode config document as an instance of
            :class:~cyberattacksim.game_modes.game_mode.GameMode` if the uuid exists,
    ...
    def update(
        ...
        if doc:
            ...
            game_mode.doc_metadata.updated_at = doc['_doc_metadata'][
                'updated_at']
    ...
    def remove(self, game_mode: GameMode) -> Union[str, None]:
        """Remove a :class:`~cyberattacksim.game_modes.game_mode.GameMode`.
        from the db.

        :param game_mode: An instance of :class:`~cyberattacksim.game_modes.game_mode.GameMode`.
        :return: The uuid of the removed :class:`~cyberattacksim.game_modes.game_mode.GameMode`.
        """
    ...
    def reset_default_game_modes_in_db(self, force=False):
        ...
        `cyberattacksim/game_modes/_package_data/game_mode.json` db file into TinyDB,
        ...
        default_game_mode_path = os.path.join(game_mode_root, '_package_data',
                                              'game_modes.json')
        ...
        for game_mode in default_db.all():
            ...
            if reset:
                ...
                _LOGGER.info(f"Reset default game_mode '{name}' in the "
    ...
    def rebuild_db(self):
        ...
        Actions taken:
            ...
            - truncate the db
            - call :func:`~cyberattacksim.game_modes.game_mode_db.GameModeDB.reset_default_game_modes_in_db`
        ...
        .. warning::
                ...
                using the :func:`~cyberattacksim.game_modes.game_mode_db.GameModeDB.reset_default_game_modes_in_db`
                function.
        """
