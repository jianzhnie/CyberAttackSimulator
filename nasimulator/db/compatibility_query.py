...
class EntryNodeCompatibilityQuery(Query):
    """The :class:`~yawning_titan.db.query.YawningTitanQuery` class extends
    ...
    compatibility of :class: `~yawning_titan.game_modes.game_mode.GameMode` and
    :class: `~yawning_titan.networks.network.Network` objects.
    """
