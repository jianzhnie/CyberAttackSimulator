...
This file contains a short CLI and the associated code for generating data for
downstream training of Dynamic Casual Bayesian Optimisation (DCBO).
"""
...
from cyberattacksim.integrations.dcbo.utils import create_env, init_dcbo_agent
...
parser.add_argument('--max_steps',
                    default=70,
                    help='Max number of steps to collect data for',
                    type=int)
parser.add_argument(
    '--initial_probabs',
    nargs='*',
...
all_envs = [
    create_env(use_same_net=args.use_standard_net)
