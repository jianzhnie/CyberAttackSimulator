...
class KeyboardAgent:
    ...
    def __init__(self, env: GenericNetworkEnv):
        ...
        print('Playing With:')
        print(
            f'  Network: {env.network_interface.current_graph._doc_metadata.name}'
        )
        print(
            f'  Game Mode: {env.network_interface.game_mode._doc_metadata.name}'
        )
        print('')
        print('When selecting an option, enter the integer key provided and '
    ...
    def get_move_set(self):
        ...
        node_list = [
            'Node ' + str(i)
            for i in network_interface.current_graph.get_nodes()
        ]
    ...
    def play(self, render_graphically: bool = True):
        ...
        while not done:
            ...
            secondary_actions = move_set[
                possible_top_actions[chosen_top_action]]
                ...
                while not secondary_action_legal:
                    ...
                    try:
                        ...
                        if chosen_secondary_action in [
                            ...
                            print(
                                f'Invalid Input Entered ({chosen_secondary_action})'
                            )
                    except ValueError:
                        print(
                            f'Invalid Input Entered ({chosen_secondary_action})'
        ...
        if (self.env.current_duration == self.env.network_interface.game_mode.
