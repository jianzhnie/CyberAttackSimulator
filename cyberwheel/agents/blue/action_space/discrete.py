...
class ActionRangeChecker:
    """
    A helper class to check if an action index falls within a specified range.
...
class DiscreteActionSpace(ActionSpace):
    """
    A concrete implementation of the ActionSpace class for discrete action spaces.
    ...
    def add_action(self, name: str, action: BlueAction, **kwargs) -> None:
        ...
        self.action_checkers.append(
            ActionRangeChecker(name, action, action_type, lower_bound, upper_bound)
        )
