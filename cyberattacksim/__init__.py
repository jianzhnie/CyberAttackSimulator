...
_CAS_HOME_DIR: Final[Union[Path, WindowsPath, PosixPath]] = Path(
    __file__).parent.parent.resolve()

_CAS_PLATFORM_DIRS: Final[Union[Path, WindowsPath,
...
LOG_DIR: Final[Union[Path, WindowsPath, PosixPath]] = _CAS_USER_DIRS / 'logs'
"""The path to the app log directory as an instance of `Path` or `PosixPath`, depending on the OS."""

DB_DIR: Final[Union[Path, WindowsPath, PosixPath]] = _CAS_PLATFORM_DIRS / 'db'
...
APP_IMAGES_DIR: Final[Union[Path, WindowsPath,
                            PosixPath]] = (_CAS_PLATFORM_DIRS / 'app_images')
