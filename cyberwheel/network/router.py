...
class Router(NetworkObject):
    def __init__(
        ...
        **kwargs,
        ...
        """
        super().__init__(name, firewall_rules if firewall_rules is not None else [])
        self.default_route: Optional[Union[ipa.IPv4Address, ipa.IPv6Address]] = None
        self.interfaces: Dict[str, Union[ipa.IPv4Address, ipa.IPv6Address]] = {}
    ...
    def get_default_route(self) -> Optional[Union[ipa.IPv4Address, ipa.IPv6Address]]:
        """
    ...
    def add_subnet_interface(self, subnet) -> None:
        """
        Adds a subnet interface to the router and assigns an IP address to it.
