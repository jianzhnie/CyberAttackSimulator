...
class NetworkDB:
    ...
    def insert(
        ...
        :param network: An instance of :class:`~cyberattacksim.networks.network.Network`
            :class:`~cyberattacksim.db._doc_metadata.DocMetadata`.
            :class:`~cyberattacksim.db._doc_metadata.DocMetadata`.
            :class:`~cyberattacksim.db._doc_metadata.DocMetadata`.
    ...
    def all(self) -> List[Network]:
        """Get all :class:`~cyberattacksim.networks.network.Network` from the
        network DB.
    ...
    def get(self, uuid: str) -> Union[Network, None]:
        ...
        :return: The network config document as an instance of
            :class:`~cyberattacksim.networks.network.Network` if the uuid exists,
    ...
    def update(
        ...
        """Update a :class:`~cyberattacksim.networks.network.Network`. in the
        db.
        ...
        :param description: The config description.
        :param author: The config author.
        :return: The updated :class:`~cyberattacksim.networks.network.Network`.
        """
    ...
    def remove(self, network: Network) -> Union[str, None]:
        """Remove a :class:`~cyberattacksim.networks.network.Network`. from the
        db.

        :param network: An instance of :class:`~cyberattacksim.networks.network.Network`.
        :return: The uuid of the removed :class:`~cyberattacksim.networks.network.Network`.
        """
    ...
    def reset_default_networks_in_db(self, force=False):
        ...
        `cyberattacksim/networks/_package_data/network.json` db file into TinyDB,
    ...
    def rebuild_db(self):
        ...
        Actions taken:
            ...
            - truncate the db
            - call :func:`~cyberattacksim.networks.network_db.NetworkDB.reset_default_networks_in_db`
        ...
        .. warning::
                ...
                using the :func:`~cyberattacksim.networks.network_db.NetworkDB.reset_default_networks_in_db`
                function.
        """
...
def dcbo_base_network() -> Network:
    ...
    .. node::
        ...
        `cyberattacksim/integrations/dcbo/base_net.txt`.
