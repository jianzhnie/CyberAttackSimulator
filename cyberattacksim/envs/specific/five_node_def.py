...
class FiveNodeDef(gym.Env):
    ...
    def __init__(
        ...
        self.red = NSARed(self.attacker_skill, [0, 1], [0, 0], [],
                          zd_gain=1,
                          zd_start_amount=1)
    ...
    def step(self, action: int) -> Tuple[np.array, float, bool, dict]:
        ...
        self.uncompromised_nodes = nodes.get_uncompromised_nodes(
            self.machine_states)
        self.compromised_machines = nodes.get_compromised_nodes(
            self.machine_states)
