...
class AIRL(PPO):
    ...
    def update(self, writer):
        ...
        for _ in range(self.epoch_disc):
            ...
            states, _, _, next_states, log_pis, _, dones = self.buffer.sample(self.batch_size)
            # Samples from expert's demonstrations.
            states_exp, actions_exp, _, next_states_exp, _, _, dones_exp = self.buffer.sample(self.batch_size)
