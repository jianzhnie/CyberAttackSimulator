...
class NetworkInterface:
    ...
    def initialise_deceptive_nodes(self):
        ...
        `~yawning_titan.networks.node.Node` objects take represent deceptive
        nodes.
        """
                ...
                if success is False:
                    ...
                    if target_node.blue_view_compromised_status == 1:
                        if (self.game_mode.blue.attack_discovery.
                                succeeded_attacks_known_compromise.use.value):
                            if (self.game_mode.blue.attack_discovery.
                                    succeeded_attacks_known_compromise.chance.
                        ...
                        if (self.game_mode.blue.attack_discovery.
                                succeeded_attacks_unknown_compromise.use.value
                            ):
                            if (100 * self.game_mode.blue.attack_discovery.
    ...
    def add_deceptive_node(self, node1: Node,
        ...
        if self.base_graph.has_edge(node1, node2):
            ...
            if (self.game_mode.blue.action_set.deceptive_nodes.
                    new_node_on_relocate.value):
    ...
    def save_json(self, data_dict: dict, ts: int) -> None:
        ...
        name = ('yawning_titan/envs/helpers/json_timesteps/output_' + str(ts) +
                '_' + str(time_stamp) + '.json')
