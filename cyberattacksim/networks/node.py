...
class Node:
    """A Node for building networks with
    cyberattacksim.networks.network.Network."""
    ...
    def reset_vulnerability(self):
        """Resets the nodes current `vulnerability_score` to the original
        `vulnerability`."""
    ...
    def __repr__(self):
        ...
        node_str += (f'high_value_node={self._high_value_node}, '
