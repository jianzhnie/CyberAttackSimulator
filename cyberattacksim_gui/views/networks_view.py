...
from cyberattacksim_gui.forms.network_forms import NetworkSearchForm
        ...
        dialogue_boxes = [
            {
                'id': 'delete-dialogue',
                'message':
                'Are you sure you want to delete the selected network(s)?\n\nThis action cannot be undone.',
    ...
    def post(self, request: HttpRequest, *args, **kwargs):
        ...
        if search_form.is_valid():
            if search_form.filters:
                ...
                networks = [
                    n.doc_metadata.uuid for n in NetworkManager.db.all()
                ]
