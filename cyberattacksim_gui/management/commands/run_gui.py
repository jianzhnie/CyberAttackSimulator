...
from cyberattacksim_server.wsgi import application
...
class CyberAttackServer:
    ...
    def run(self):
        ...
        if OPERATING_SYSTEM == 'darwin':
            ...
            server_process = Process(target=self.server,
                                     kwargs=self.server_kwargs or {})
        else:
            server_process = Thread(target=self.server,
                                    kwargs=self.server_kwargs or {})
