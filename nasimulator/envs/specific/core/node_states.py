...
This module contains helper functions to find compromised and uncompromised
nodes for the four-node-def-v0 and five-node-def-v0 environments.
"""
...
def get_linked_node_state(
        current_position: int, network: nx.Graph,
        machine_states: List[List[float]]) -> Tuple[List[int], List[int]]:
...
def get_linked_compromised_nodes(
        current_position: int, network: nx.Graph,
        machine_states: List[List[float]]) -> List[int]:
    """Return a list containing all the linked compromised nodes relative to
    the red agents current position.
...
def get_linked_uncompromised_nodes(
        current_position: int, network: nx.Graph,
        machine_states: List[List[float]]) -> List[int]:
    """Return a list containing all the linked uncompromised nodes relative to
    the red agents current position.
