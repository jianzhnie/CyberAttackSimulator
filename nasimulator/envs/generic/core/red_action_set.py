...
class RedActionSet:
    ...
    def choose_target_node(
        ...
        original_node = {}
        if (self.network_interface.game_mode.red.agent_attack.attack_from.
                any_red_node.value):
        ...
        elif (self.network_interface.game_mode.red.agent_attack.attack_from.
              only_main_red_node.value):
            ...
            if self.network_interface.red_current_location is not None:
                ...
                for node in connected:
                    if node.true_compromised_status == 0:
                        original_node[
                            node] = self.network_interface.red_current_location
        ...
        if self.network_interface.game_mode.red.target_mechanism.random.value:
            ...
            weights = [1] * len(possible_to_attack)
              ...
              prioritise_connected_nodes.value):
            for node in possible_to_attack:
              ...
              prioritise_unconnected_nodes.value):
            for node in possible_to_attack:
            ...
            for dist in distances:
                if (self.network_interface.game_mode.red.target_mechanism.
                        target_specific_node.always_choose_shortest_distance.
                        value):
