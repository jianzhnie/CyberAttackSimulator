...
.. glossary::
    Blue Agent
        Within :term:`CyberAttackSim<CyberAttackSim>`, a |Blue Agent| blue agent represents a friendly :term:`AI<Artificial Intelligence>`
...
.. glossary::
    Red Agent
        Within :term:`CyberAttackSim<CyberAttackSim>`, a |Red Agent| represents an adversary that is designed to attack and infect one
