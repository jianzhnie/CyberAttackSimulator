...
_YT_ROOT_DIR: Final[Union[Path, WindowsPath,
...
_YT_USER_DIRS: Final[Union[Path, WindowsPath,
                           PosixPath]] = (Path.home() / 'yawning_titan')
...
DB_DIR: Final[Union[Path, WindowsPath,
                    PosixPath]] = (_YT_PLATFORM_DIRS.user_data_path / 'db')
...
APP_IMAGES_DIR: Final[Union[Path, WindowsPath,
                            PosixPath]] = (_YT_PLATFORM_DIRS.user_data_path /
                                           'app_images')
...
NOTEBOOKS_DIR: Final[Union[Path, WindowsPath,
                           PosixPath]] = _YT_USER_DIRS / 'notebooks'
"""
...
GAME_MODES_DIR: Final[Union[Path, WindowsPath,
                            PosixPath]] = (_YT_USER_DIRS / 'game_modes')
"""
...
IMAGES_DIR: Final[Union[Path, WindowsPath,
                        PosixPath]] = _YT_USER_DIRS / 'images'
"""
...
VIDEOS_DIR: Final[Union[Path, WindowsPath,
                        PosixPath]] = _YT_USER_DIRS / 'videos'
"""
...
AGENTS_DIR: Final[Union[Path, WindowsPath,
                        PosixPath]] = _YT_USER_DIRS / 'agents'
"""
...
AGENTS_LOGS_DIR: Final[Union[Path, WindowsPath,
                             PosixPath]] = (_YT_USER_DIRS / 'agents' / 'logs')
"""
...
with open(_YT_ROOT_DIR / 'config' / '_package_data' / 'logging_config.yaml',
          'r') as stream:
