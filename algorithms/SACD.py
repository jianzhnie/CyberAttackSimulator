...
class SACD_agent():
	...
	def save(self, timestep, EnvName):
		torch.save(self.actor.state_dict(), f"./algorithms/sarl/model/SACD/sacd_actor_{timestep}_{EnvName}.pth")
		torch.save(self.q_critic.state_dict(), f"./algorithms/sarl/model/SACD/sacd_critic_{timestep}_{EnvName}.pth")


	def load(self, timestep, EnvName):
		self.actor.load_state_dict(torch.load(f"./algorithms/sarl/model/SACD/sacd_actor_{timestep}_{EnvName}.pth", map_location=self.dvc))
		self.q_critic.load_state_dict(torch.load(f"./algorithms/sarl/model/SACD/sacd_critic_{timestep}_{EnvName}.pth", map_location=self.dvc))
