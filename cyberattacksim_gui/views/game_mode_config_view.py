...
from cyberattacksim_gui.forms.game_mode_forms import (GameModeForm,
                                                      GameModeFormManager,
                                                      GameModeSection)
...
class GameModeConfigView(View):
    ...
    def post(
        ...
        **kwargs,
        ...
        if section.config_class.validation.passed:
            if (section_name == game_mode_form.last_section.name
    ...
    def render_page(
        ...
        """Process pythonic tags in game_mode_config.html and return formatted
        page.
        ...
        return render(
            ...
            {
                'sections':
                game_mode_form.sections,
                'section':
                section,
                'doc_metadata_form':
                game_mode_form.doc_metadata_form,
                'current_section_name':
                section.name,
                'last':
                False,
                'toolbar':
                get_toolbar('Manage game modes'),
                'game_mode_name':
                game_mode_form.game_mode.doc_metadata.name,
                'game_mode_id':
                game_mode_form.game_mode.doc_metadata.uuid,
                'game_mode_description':
                game_mode_form.game_mode.doc_metadata.description
                if game_mode_form.game_mode.doc_metadata.description else '',
                'protected':
                game_mode_form.game_mode.doc_metadata.locked,
            },
        )
