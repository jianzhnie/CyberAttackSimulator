...
from cyberattacksim_gui.views.utils.helpers import (get_network_layouts,
                                                    get_toolbar)
...
class NetworkEditor(View):
    ...
    def get(self,
        ...
        return render(
            ...
            {
                'toolbar':
                get_toolbar('Manage networks'),
                'form':
                network_form,
                'doc_metadata_form':
                network_form.doc_metadata_form,
                'protected':
                network_form.network.doc_metadata.locked,
                'network_id':
                network_id,
                'network_json':
                json.dumps(
                ...
                'network_layouts':
                json.dumps(get_network_layouts()),
            },
        )
