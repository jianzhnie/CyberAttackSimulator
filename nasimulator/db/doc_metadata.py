...
class DocMetadata:
    ...
    they are not passed as params. Once set, they cannot be changed.
    """
    ...
    def __init__(
        ...
        """The :class:`~yawning_titan.db.yawning_titan_db.DocMetadata`
        constructor.
        ...
        self._created_at: Final[str] = (created_at if created_at is not None
    ...
    def to_dict(self, include_none: bool = False) -> Dict[str, str]:
        """Serialize the
        :class:`~yawning_titan.db.yawning_titan_db.DocMetadata` as a
        :py:class:`dict`.
...
class DocMetadataSchema:
    ...
    DESCRIPTION: Final[YawningTitanQuery] = YawningTitanQuery(
